...
class AlertsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(AppStrings.allerts),
        leading: IconButton(
          onPressed: () {
      ...
      body: Obx(
        () {
          ...
          } else if (postsController.alerts.isEmpty) {
                ...
                children: [
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemCount: postsController.alerts.length,
                      itemBuilder: (context, index) {
                        var alert = postsController.alerts[index];
                        return PostItem(
                          post: alert,
                        );
                      },
